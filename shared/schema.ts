...
export const userProfiles = pgTable("user_profiles", {
  ...
  virtualRoomId: integer("virtual_room_id").references(() => rooms.id), // Virtual room ID for online sessions
...
export const practiceConfiguration = pgTable("practice_configuration", {
  ...
  practiceWebsite: varchar("practice_website", { length: 255 }).default("https://resiliencecrm.com"),
