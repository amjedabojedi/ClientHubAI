...
SUITES=(
  ...
  "test/insurance-statement-second-payment-banked.test.ts"
  ...
  "test/insurance-duplicate-tolerance-unit.test.ts"
  ...
  "test/billing-payment-stale-reload-totals-ui.test.ts"
  "test/client-detail-payment-stale-reload-totals-ui.test.ts"
  "test/client-detail-insurance-payment-stale-reload-totals-ui.test.ts"
  ...
  "test/discount-payment-void-status-flip.test.ts"
  "test/discount-payment-record-status-flip.test.ts"
  "test/discount-payment-full-discount-paid.test.ts"
  "test/discount-payment-void-full-discount-paid.test.ts"
