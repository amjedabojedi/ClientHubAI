...
const ChecklistManagement = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-slate-900">Healthcare Process Checklists</h1>
        <p className="text-slate-600 mt-1">Create and manage standardized healthcare process checklists for regulatory compliance</p>
      </div>
